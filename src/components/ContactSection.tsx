        ...
        <div className="grid md:grid-cols-2 gap-12 mt-12">
          ...
          >
            ...
            <div className="space-y-4">
              <div onMouseMove={handleSpotlight} className="spotlight-card flex items-center gap-4 p-4 rounded-none border border-section-dark-fg/10 bg-section-dark-fg/5 hover:bg-section-dark-fg/10 hover:border-accent/30 transition-all cursor-default">
            ...
            <div className="flex gap-4">
              {socialLinks.map(({ icon: Icon, href, label }) => (
                <a key={label} href={href} target="_blank" rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center border border-section-dark-fg/10 hover:border-accent hover:text-accent hover:scale-110 transition-all text-section-dark-fg/50">
          ...
          >
            ...
            <button type="submit" disabled={isSubmitting || isSubmitted}
              className="w-full bg-accent text-accent-foreground py-3 px-6 font-semibold text-sm hover:scale-[1.02] hover:shadow-lg hover:shadow-accent/20 transition-all disabled:opacity-50 flex items-center justify-center gap-2">
